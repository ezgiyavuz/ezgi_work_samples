...
dataframe_control = pd.read_excel("C:/Users/ezgi ay/PycharmProjects/dsmlbc_9_abdulkadir/Homeworks/ezgi_yavuzay/Odev_Hafta_4/ab_testing.xlsx",sheet_name="Control Group")
dataframe_test = pd.read_excel("C:/Users/ezgi ay/PycharmProjects/dsmlbc_9_abdulkadir/Homeworks/ezgi_yavuzay/Odev_Hafta_4/ab_testing.xlsx" , sheet_name="Test Group")
...
#iki orneklem bagımsız t testi, varsayımlar saglandı

# Adım 2: Elde ettiğiniz test sonuçlarına göre müşteriye tavsiyede bulununuz.

#ornek sayısı cogaltılarak tekrardan test yapılabilir.